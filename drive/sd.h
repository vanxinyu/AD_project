...
#define SD_SPI_SCK_PIN                   GPIO_Pin_8                /* PA.05 */
#define SD_SPI_SCK_GPIO_PORT             GPIOD                       /* GPIOA */
#define SD_SPI_SCK_GPIO_CLK              RCC_AHBPeriph_GPIOD
#define SD_SPI_SCK_SOURCE                GPIO_PinSource8
